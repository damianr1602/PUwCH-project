...
/*GetVersionOK returns the current version
...
func (o *GetVersionDefault) WithPayload(payload *models.Result) *GetVersionDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get version default response
func (o *GetVersionDefault) SetPayload(payload *models.Result) {
	o.Payload = payload
}
